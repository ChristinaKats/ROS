...
class PublicMetr():
	...
	def __init__(self):
		...
		self.sub_metrics = rospy.Publisher('/metrics_topic', Num, queue_size=100)
		rospy.init_node('metrics', anonymous=True)

		rate = rospy.Rate(200)
		with open('/home/christina/catkin_ws/src/multiple_turtlebots_nav/src/sources_v3.csv', mode='r') as csv_file:
